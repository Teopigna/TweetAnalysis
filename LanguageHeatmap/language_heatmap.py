...
fig = go.Figure(go.Heatmap(
                   ...
                   "Hungarian","Czechoslovak","Dutch",
                   "Italian","Russian","Chinese",
                   "Polish","Punjabi","Hebrew","Sorani Kurdish",
                    "Pashto","Vietnamese","French",
                     "Urdu", "Portuguese","Finnish",
                     "Norwegian","Danish","Sindhi",
                     "Japanese","Catalan","EU","Hindi",
                     "Swedish","Ukrainian","Korean",
                     "Latvian","Icelandic","Lithuanian",
                     "Indonesian","Welsh","Estonian",
                     "Haitian","Filipinine", "Bulgarian",
                      "Thai", "Malayalam","Uyghur","Bengali",
                      "Marathi","Undefined"],
                   hoverongaps = False))
